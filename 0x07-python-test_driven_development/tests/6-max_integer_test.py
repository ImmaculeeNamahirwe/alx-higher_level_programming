...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_one_element(self):
        """Tests for only one number in a list"""
        o = [1]
    ...
    def test_one_negative(self):
        """Tests for list with the one negative number"""
        on = [200, 10, 8, -36, 14, 50]
        self.assertEqual(max_integer(on), 200)

    def test_all_negative(self):
        """Tests for the list with all negative numbers"""
        n = [-6, -50, -75, -1, -100]
    ...
    def test_non_int_arg(self):
        """Tests for the non-int type in list"""
