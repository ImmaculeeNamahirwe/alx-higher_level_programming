...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_positive_middle(self):
        """Tests for all positive wi the th max in middle"""
        m = [2, 10, 8, 360, 14, 50]
        self.assertEqual(max_integer(m), 360)

    def test_positive_beginning(self):
        """Tests for all positive with max the at beginning"""
        b = [200, 10, 8, 36, 14, 50]
        self.assertEqual(max_integer(b), 200)

    def test_one_negative(self):
        """Tests for list with one the negative number"""
        on = [200, 10, 8, -36, 14, 50]
        self.assertEqual(max_integer(on), 200)

    def test_all_negative(self):
        """Tests for list with all the negative numbers"""
        n = [-6, -50, -75, -1, -100]
